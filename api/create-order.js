...
// REMOVED: const { restResources } = require('@shopify/shopify-api/rest/admin/latest');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Create a Draft Order using shopify.rest (this is the correct way)
    const draftOrder = new shopify.rest.DraftOrder({ session }); // This line remains the same
